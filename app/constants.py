...
PRESSURE_OUT_DIR = os.path.join(OUTPUT_DIR, STEP_03_PRESSURE)
...
PRESSURE_PROMPT_DIR = os.path.join(PROMPT_DIR, "pressure")
...
PRESSURE_PROMPT_DRAFT = os.path.join(PRESSURE_PROMPT_DIR, "draft.txt")
